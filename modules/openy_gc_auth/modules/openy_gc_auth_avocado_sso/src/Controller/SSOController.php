...
//    if (!$this->avocadoSSOClient->validateCsrfToken($request->get('state'))) {
...
//    }
    ...
    \Drupal::logger('debug')->info(print_r($request, TRUE));
    // @TODO: Consider making authentication_token as a property for the avocado SSO client.
    $authentication_token = $this->avocadoSSOClient->retrieveAuthenticationToken($request->get('code'));
    ...
    $user_data = $this->avocadoSSOClient->requestUserData($authentication_token);
    ...
    // @TODO: Confirm the email can be accessed as "->email".
    $user_membership_data = $this->avocadoSSOClient->requestUserMembershipData($authentication_token, $user_data->email);
    ...
    $result = $this->avocadoSSOClient->createUserLoggedInEvent($authentication_token, $user_membership_data->memberBarcode);
