...
abstract class GCIdentityProviderPluginBase extends PluginBase implements GCIdentityProviderInterface, ContainerFactoryPluginInterface {
   ...
   * {@inheritdoc}
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, ConfigFactoryInterface $config, EntityTypeManagerInterface $entity_type_manager, FormBuilderInterface $form_builder, GCUserService $gc_user_service) {
